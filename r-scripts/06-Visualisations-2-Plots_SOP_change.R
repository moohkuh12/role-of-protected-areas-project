...
# This is the corresponding plot script to the 05-WP1-data_analysis_MODELS_PAeffects_SOP.R script.
# The names of the models are:
# 1 General models: 
# m1_sop - logratio ~ protection_cat
# m1.1_sop - logratio ~ protection_90
# m1.2_sop - logratio ~ protection_80
# m1.3_sop - logratio ~ protection_70
# m1.4_sop - logratio ~ protection_60
# m1.5_sop - logratio ~ protection_50

# 2 Models for Nitrogen interaction:
# m2.1_sop - logratio ~ protection_cat * EIVEres.N
# m2.1.1_sop - logratio ~ protection_90 * EIVEres.N
# m2.1.2_sop - logratio ~ protection_80 * EIVEres.N
# m2.1.3_sop - logratio ~ protection_70 * EIVEres.N
# m2.1.4_sop - logratio ~ protection_60 * EIVEres.N
# m2.1.5_sop - logratio ~ protection_50 * EIVEres.N

# 3 Models for Ph Reaction interaction:
# m2.2_sop - logratio ~ protection_cat * EIVEres.R
# m2.2.1_sop - logratio ~ protection_90 * EIVEres.R
# m2.2.2_sop - logratio ~ protection_80 * EIVEres.R
# m2.2.3_sop - logratio ~ protection_70 * EIVEres.R
# m2.2.4_sop - logratio ~ protection_60 * EIVEres.R
# m2.2.5_sop - logratio ~ protection_50 * EIVEres.R

# 4 Models for Temperature interaction:
# m2.3_sop - mean_occ_change ~ protection_cat * EIVEres.T
# m2.3.1_sop - logratio ~ protection_90 * EIVEres.T
# m2.3.2_sop - logratio ~ protection_80 * EIVEres.T
# m2.3.3_sop - logratio ~ protection_70 * EIVEres.T
# m2.3.4_sop - logratio ~ protection_60 * EIVEres.T
# m2.3.5_sop - logratio ~ protection_50 * EIVEres.T

# 5 Models for Moisture interaction:
# m2.4_sop - logratio ~ protection_cat * EIVEres.M
# m2.4.1_sop - logratio ~ protection_90 * EIVEres.M
# m2.4.2_sop - logratio ~ protection_80 * EIVEres.M
# m2.4.3_sop - logratio ~ protection_70 * EIVEres.M
# m2.4.4_sop - logratio ~ protection_60 * EIVEres.M
# m2.4.5_sop - logratio ~ protection_50 * EIVEres.M

# 6 Models for Light interaction:
# m2.5_sop - logratio ~ protection_cat * EIVEres.L
# m2.5.1_sop - logratio ~ protection_90 * EIVEres.L
# m2.5.2_sop - logratio ~ protection_80 * EIVEres.L
# m2.5.3_sop - logratio ~ protection_70 * EIVEres.L
# m2.5.4_sop - logratio ~ protection_60 * EIVEres.L
# m2.5.5_sop - logratio ~ protection_50 * EIVEres.L

# 7 Models for Main Group interaction:
# m2.6_sop - logratio ~ protection_cat * main_group
# m2.6.1_sop - logratio ~ protection_90 * main_group
# m2.6.2_sop - logratio ~ protection_80 * main_group
# m2.6.3_sop - logratio ~ protection_70 * main_group
# m2.6.4_sop - logratio ~ protection_60 * main_group
# m2.6.5_sop - logratio ~ protection_50 * main_group

# 8 Models for Plant Growth Form interaction:
# m2.7_sop - logratio ~ protection_cat * PlantGrowthForm
# m2.7.1_sop - logratio ~ protection_90 * PlantGrowthForm
# m2.7.2_sop - logratio ~ protection_80 * PlantGrowthForm
# m2.7.3_sop - logratio ~ protection_70 * PlantGrowthForm
# m2.7.4_sop - logratio ~ protection_60 * PlantGrowthForm
# m2.7.5_sop - logratio ~ protection_50 * PlantGrowthForm

# 9 Models for Woodiness interaction:
# m2.8_sop - logratio ~ protection_cat * Woodiness
# m2.8.1_sop - logratio ~ protection_90 * Woodiness
# m2.8.2_sop - logratio ~ protection_80 * Woodiness
# m2.8.3_sop - logratio ~ protection_70 * Woodiness
# m2.8.4_sop - logratio ~ protection_60 * Woodiness
# m2.8.5_sop - logratio ~ protection_50 * Woodiness

# 10 Models for Leaf Type interaction:
# m2.9_sop - logratio ~ protection_cat * LeafType
# m2.9.1_sop - logratio ~ protection_90 * LeafType
# m2.9.2_sop - logratio ~ protection_80 * LeafType
# m2.9.3_sop - logratio ~ protection_70 * LeafType
# m2.9.4_sop - logratio ~ protection_60 * LeafType
# m2.9.5_sop - logratio ~ protection_50 * LeafType
...
preds <- ggpredict(m1_sop, terms = c( "protection_cat"))
# Scale estiamtes to percentage
preds$predicted_pct <- (exp(preds$predicted) - 1) * 100
preds$conf.low_pct <- (exp(preds$conf.low) - 1) * 100
preds$conf.high_pct <- (exp(preds$conf.high) - 1) * 100

preds$group <- factor(preds$group)

# 1) left panel: half-violins + rawdatapoints + boxplot
p1 <- ggplot(summary_general, aes(x = protection_cat, y = (exp(logratio) - 1) * 100)) +
  coord_flip() +
  geom_hline(yintercept = 0, linetype = "dashed", color = "grey30", linewidth = 0.8) + 
  # Violinplots
  geom_half_violin(
    data = summary_general,
    aes(x = protection_cat, y = (exp(logratio) - 1) * 100, fill = protection_cat),
    side = "l", alpha = 0.45, color = NA, position = position_nudge(x = -0.05), scale= "count"
  ) +
  # slimmer boxplots
  geom_boxplot(
    data = summary_general,
    aes(x = protection_cat, y = (exp(logratio) - 1) * 100, fill = protection_cat, color= protection_cat),
    width = 0.1,
    outlier.shape = NA,
    linewidth = 0.8,
...
p2 <- ggplot() +
  ...
  geom_jitter(
    data = summary_general,
    aes(x = protection_cat, y = (exp(logratio) - 1) * 100, color = protection_cat),
    width = 0.09,
    size = 1.5,
    alpha = 0.15
  ) +
  ...
  geom_errorbar(
    data = preds,
    aes(x = x, ymin = conf.low_pct, ymax = conf.high_pct, color = "black"),
    width = 0.03,
    color="black",
    linewidth = 1,
  ...
  geom_point(
    data = preds,
    aes(x = x, y = predicted_pct, color = "black"),
    size = 2,
    color= "black",
    #  position = position_nudge(x = 0.12),
    alpha = 0.7
...
m1.2_SOPplot <- wrap_elements(panel = p_patch) +
  labs(tag = expression(paste("Predicted change in SOP"[italic(Spec)],"(%)"))) +
  theme(
    text  = element_text(family = "roboto_condensed"),
...
# 5) save the plot
ggsave("./figures/SOP_comparison.png",
       m1.2_SOPplot,
...
protection_vars_sop <- c(
  m1.1_sop = "protection90",
  m1.2_sop = "protection80",
  m1.3_sop = "protection70",
  m1.4_sop = "protection60",
  m1.5_sop = "protection50"
)

for (model_name in names(model_list_sop)) {
  
  m1_sop <- model_list_sop[[model_name]]
  protection_var_sop <- protection_vars_sop[[model_name]]
  
  summary_prot <- get(paste0("summary_prot", substr(protection_var_sop, 11, 12)))
  stopifnot(protection_var_sop %in% names(summary_prot))
  
  preds <- ggpredict(m1_sop, terms = protection_var_sop)
  ...
  p1 <- ggplot(summary_general, aes_string(x = "protection_cat", y = "(exp(logratio) - 1) * 100")) +
    coord_flip() +
    geom_hline(yintercept = 0, linetype = "dashed", color = "grey30", linewidth = 0.8) +
    
    geom_half_violin(
      data = summary_prot,
      aes_string(x = protection_var_sop, y = "(exp(logratio) - 1) * 100", fill = protection_var_sop),
      side = "l", alpha = 0.45, color = NA, position = position_nudge(x = -0.05), scale = "count"
    ) +
    
    geom_boxplot(
      data = summary_prot,
      aes_string(x = protection_var_sop, y = "(exp(logratio) - 1) * 100", fill = protection_var_sop, color = protection_var_sop),
      width = 0.1,
      outlier.shape = NA,
      linewidth = 0.8,
      position = position_nudge(x = 0.1),
    ...
    labs(
      title = paste("Protection threshold:", substr(protection_var_sop, 11, 12), "%"),
      x = protection_var_sop,
      y = NULL,
      color = "Protection",
      fill = "Protection"
    ) +
  ...
  p2 <- ggplot() +
    ...
    geom_jitter(
      data = summary_prot,
      aes_string(x = protection_var_sop, y = "(exp(logratio) - 1) * 100", color = protection_var_sop),
      width = 0.09,
      size = 1.5,
      alpha = 0.15
    ) +
  ...
  # Combine panels
  final_plot_sop <- wrap_elements(panel = p1 + p2 & xlab(NULL) & theme(plot.margin = margin(5.5, 20, 0, 5.5))) +
    labs(tag = expression(paste("Predicted change in SOP"[italic(Spec)],"(%)"))) +
    theme(
      text = element_text(family = "roboto_condensed"),
      plot.tag = element_text(size = rel(8)),
  ...
  # Save
  ggsave(
    filename = paste0("./figures/SOP-change-threshs/SOP_change_", protection_var_sop, ".png"),
    plot = final_plot_sop,
    width = 40,
    height = 20,
    units = "cm",
